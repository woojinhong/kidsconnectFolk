...
const Avatar = polymorphicFactory.polymorphicFactory((_props, ref) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    Box.Box,
    {
      ...
      ref,
      ...others,
      children: error ? /* @__PURE__ */ jsxRuntime.jsx("span", { ...getStyles("placeholder"), title: alt, children: children || /* @__PURE__ */ jsxRuntime.jsx(AvatarPlaceholderIcon.AvatarPlaceholderIcon, {}) }) : /* @__PURE__ */ jsxRuntime.jsx(
        "img",
        {
          ...imageProps,
          ...getStyles("image"),
